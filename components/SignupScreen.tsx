...
export function SignupScreen({ onSignup, onSwitchToLogin, onBack, darkMode }: SignupScreenProps) {
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12">
      ...
      >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              ...
              <div className="relative">
                <User className={`absolute left-3 top-1/2 -translate-y-1/2 size-4 ${darkMode ? 'text-slate-400' : 'text-slate-500'
                  }`} />
                <Input
                  id="name"
                  type="text"
            ...
            >
              ...
              <div className="relative">
                <Mail className={`absolute left-3 top-1/2 -translate-y-1/2 size-4 ${darkMode ? 'text-slate-400' : 'text-slate-500'
                  }`} />
                <Input
                  id="email"
                  type="email"
            ...
            >
              ...
              <div className="relative">
                <Lock className={`absolute left-3 top-1/2 -translate-y-1/2 size-4 ${darkMode ? 'text-slate-400' : 'text-slate-500'
                  }`} />
                <Input
                  id="password"
                  type="password"
        ...
        <motion.p
          ...
          className={`text-xs text-center mt-6 ${darkMode ? 'text-slate-500' : 'text-slate-500'
            }`}
        >
